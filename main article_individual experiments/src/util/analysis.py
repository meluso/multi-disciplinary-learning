...
def create_executions_dicts():
    ...
    model2simprop = {
        '2x': dict(
            execset = 7,
            exec_list = [31],
            group_vars = uv.team_indices(),
            drop_list = uv.not_team_indices()
            ),
        '2f': dict(
            execset = 4,
            exec_list = [11],
            group_vars = uv.team_and_agent_indices(),
            drop_list = uv.not_team_or_agent_indices()
            ),
        '3xx': dict(
            execset = 10,
            exec_list = [45, 46, 47, 48],
        ...
        '3fx': dict(
            execset = 5,
            exec_list = [24],
            group_vars = uv.all_level_indices(),
            drop_list = uv.not_level_indices()
            ),
        '3xg': dict(
            execset = 9,
            exec_list = [35],
