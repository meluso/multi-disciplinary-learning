...
def plot_importances_networks(save=True):
    ...
    # Set mins and maxes
    xmin, xmax, ymin, ymax = 0, 0.012, -0.05, 1.05
    ximp = 0.67
    ...
    # Guiding arrows & text
    pi.arrow(axs[0], (-0.04, 0.35), (-0.04, 0.15))
    pi.arrow(axs[0], (-0.04, 0.65), (-0.04, 0.85))
    pi.arrow(axs[0], (ximp-0.075, 0.54), (ximp+0.075, 0.54))
